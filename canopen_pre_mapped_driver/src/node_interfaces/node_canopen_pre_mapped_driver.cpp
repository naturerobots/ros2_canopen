...
template class ros2_canopen::node_interfaces::NodeCanopenPreMappedDriver<rclcpp::Node>;
template class ros2_canopen::node_interfaces::NodeCanopenPreMappedDriver<rclcpp_lifecycle::LifecycleNode>;
